...
```bash
curl -fsSL https://raw.githubusercontent.com/Polaris-d/xushi/refs/heads/main/scripts/install.sh | XUSHI_VERSION=v0.1.10 sh
```
...
xushi upgrade check --version v0.1.10
xushi upgrade backup
xushi upgrade apply --version v0.1.10 --yes
